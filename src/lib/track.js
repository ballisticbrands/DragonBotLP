...
// app.getdragonbot.com (the sign-up destination) — and `pricing_view` on
...
// user clicks any link pointing to app.getdragonbot.com. Capture phase so it
...
export function initCtaTracking() {
  document.addEventListener(
    ...
    (e) => {
      ...
      if (!href.includes('app.getdragonbot.com')) return;
      track('cta_click', {
