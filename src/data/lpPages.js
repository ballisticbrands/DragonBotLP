...
export const lpPages = [
  ...
  },
  {
    ...
    demo: {
      ...
      script: [
        { who: 'user', text: "You've got 9 unread buyer messages across my accounts. Handle them." },
        { who: 'tool', text: 'Running `message triage` across `all accounts`' },
        { who: 'host', text: 'Read and sorted:', stats: [ { v: '9', l: 'messages triaged' }, { v: '6', l: 'routine (replies drafted)' }, { v: '2', l: 'refund requests' }, { v: '1', l: 'A-to-z risk flagged' } ] },
        { who: 'user', text: 'Draft replies from my policies and flag anything risky before it sends.' },
        { who: 'tool', text: 'Drafting from your `return policy` and `shipping policy`' },
        { who: 'host', text: 'Done — 6 replies drafted for one-click approval in Slack, 2 refunds staged with the policy citation, and the A-to-z case escalated to you with a suggested response. Nothing sends without your OK, and every action is logged.' },
        { who: 'user', text: 'Auto-send the routine ones from now on.' },
        { who: 'host', text: 'Set — shipping-status and "where is my order" replies now go out autonomously within your rules; anything touching a refund, return, or complaint still comes to you first.' },
      ],
    },
  },
  {
